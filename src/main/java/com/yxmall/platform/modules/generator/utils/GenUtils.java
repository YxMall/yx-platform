package com.yxmall.platform.modules.generator.utils;

import com.yxmall.platform.common.utils.TimeUtils;
import com.yxmall.platform.modules.generator.model.Column;
import com.yxmall.platform.modules.generator.model.Table;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip) {
        ...
        map.put("datetime", TimeUtils.parseTime(LocalDateTime.now(), TimeUtils.TimeFormat.LONG_DATE_PATTERN_NONE));
        //FIXME 页面处理有问题 暂无好办法
        map.put("ref", "this.$refs");
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("index.vue.vm")) {
            return "src" + File.separator + "pages" +
                    File.separator + moduleName + File.separator + className.toLowerCase() + File.separator + "index.vue";
        }

        if (template.contains("form.vue.vm")) {
            return "src" + File.separator + "pages" +
                    File.separator + moduleName + File.separator + className.toLowerCase() + File.separator + className.toLowerCase() + "-form.vue";
        }
